function pricelist(year, sheetid, campsitename, campsitetype) {
  ...
  /* Translation */
  var headerhighseason = "High&shy;season price";
  var headerlowseason = "Low&shy;season price";
  var headernormalprice = "Normal";
  var headermemberprice = "DCU Deal";
  var pricepermonth = "Pr month";
  var pricehalfyear = "Pr half year ";
  var priceperyear = "Pr year";
  var pricenote = "See note";
  var pricefree = "Free";
  var switchtext = "Switch between Low season and high season";

  /* Finder div elementer */

  /* checker for unikke entries i dropdown listerne*/
  var items = "";
    ...
    function (err, data) {
      if (err !== null) {
        ...
        for (var item, i = 0; item = items[i++];) {
          ...
          if (kontrol != '') {
            ...
            if (comment != '') {
              ...
              footnotetext += '<div class="footnote mb-3" ><a id=' + footnotenr + '><b>' + footnotenr + ')</b></a> ' + item[14] + '</div>';
            ...
            if (showhigh == 1) {
              searchresult += '<div class="pricerow bg-even row col-header py-2">' +
                '<div class="col-6 col-md-8 item">' + item[12] + ' <sup>' + refnr + '</sup></div>' +
            ...
            if (heading != item[2]) {
              ...
              if (showhigh == 1) {
                searchresult += '<div class="row pricerow mt-4 col-header py-2">' +
                  '<div class="col-6 col-md-8 item"><strong>' + item[10] + '</strong></div>' +
        ...
        for (var item, i = 0; item = items[i++];) {
          ...
          footnotetext += '<div class="footnote mb-3"><h4>' + item[10] + '</h4><p>' + item[12] + '</p></div>';
        }
